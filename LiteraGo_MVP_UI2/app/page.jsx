...
export default function LandingPage() {
  return (
    <main className="page-shell">
      ...
      <section id="home" className="hero-grid">
        <div>
          ...
          <h1 className="hero-title">
            Temukan perpustakaan terdekat dan pinjam buku lebih <span>mudah</span>.
          </h1>
          <p className="hero-copy">
            LiteraGo membantu pengguna memilih perpustakaan berdasarkan lokasi, mencari buku sesuai kategori,
            menyimpan buku yang belum tersedia ke Wishlist, hingga menyelesaikan peminjaman melalui payment gateway
            simulasi.
          </p>
        ...
        <div className="hero-visual" aria-hidden="true">
          <div className="hero-phone">
            ...
            <div className="mock-banner">Temukan Perpustakaan, Pinjam Buku Lebih Mudah!</div>
      ...
      <section id="tentang" className="about-section section-bg">
        ...
        <div className="container about-grid section-content">
          <div className="about-text">
            ...
            <h2>
              LiteraGo hadir untuk membuat proses pencarian dan peminjaman buku
              menjadi lebih sederhana.
            </h2>
            <p>
              LiteraGo dirancang sebagai aplikasi yang membantu pengguna mencari
              perpustakaan berdasarkan wilayah, melihat ketersediaan koleksi,
              melakukan peminjaman, serta memantau buku yang sedang dipinjam.
            </p>
            <p>
          ...
          <div className="about-points">
            <article className="about-card">
              ...
              <p>
                Koleksi yang tampil menyesuaikan perpustakaan yang dipilih
                pengguna.
              </p>
            </article>
      ...
      <section id="fitur" className="features-section section-bg">
        ...
        <div className="container section-content">
          <div className="section-heading section-heading-light">
            ...
            <h2>
              Fitur yang membantu pengguna mengakses buku secara lebih
              terstruktur
            </h2>
            <p>
          ...
          <div className="features-grid">
            <article className="feature-card">
              ...
              <p>
                ...
                memilih lokasi yang paling relevan sebelum melihat stok buku.
              </p>
            </article>

            <article className="feature-card">
              <div className="feature-icon">🔎</div>
              <h3>Pencarian Buku dan Kategori</h3>
              <p>
            ...
            <article className="feature-card">
              ...
              <p>
                Pengguna memilih buku, menentukan return date, waktu
            ...
            <article className="feature-card">
              ...
              <h3>Wishlist Buku</h3>
              <p>
                Buku yang belum tersedia tetap bisa disimpan, sehingga pengguna
      ...
      {/* --- STATS SECTION (Tambahan dari kode lama Anda) --- */}
      <section className="section-block">
        <div className="stats-grid">
          <div className="stat-card">
            <strong>12+</strong>
            <span>Halaman aplikasi siap pakai</span>
          </div>
          <div className="stat-card">
            <strong>CRUD</strong>
            <span>Simulasi via localStorage</span>
          </div>
        </div>
      </section>
    </main>
