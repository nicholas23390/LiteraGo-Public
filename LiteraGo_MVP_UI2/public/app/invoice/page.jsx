...
import { getLastInvoice, initializeLiteraGo } from "@/lib/client-store";
import { findBook, findLibrary, formatRupiah } from "@/lib/data";
...
export default function InvoicePage() {
  ...
  const details = useMemo(() => {
    ...
    return {
      ...invoice,
      library: findLibrary(invoice.libraryId),
      books: invoice.items.map((id) => findBook(id)).filter(Boolean)
    };
  }, [invoice]);
